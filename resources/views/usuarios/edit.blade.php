...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl">
        <form method="POST" action="{{ route('usuarios.update', $usuario->id) }}" class="space-y-5">
            ...
            <!-- Remuneración y Costo Hora Hombre (HH) -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" id="sueldo_mensual" name="sueldo_mensual" value="{{ old('sueldo_mensual', $usuario->sueldo_mensual) }}" placeholder="Ej: 2400.00"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" id="costo_hora" name="costo_hora" value="{{ old('costo_hora', $usuario->costo_hora) }}" placeholder="Ej: 11.54"
