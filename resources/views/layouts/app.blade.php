        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-72 bg-slate-900 border-r border-slate-800 flex flex-col justify-between transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:w-64 md:h-screen md:sticky md:top-0 shrink-0 overflow-y-auto scrollbar-thin"
            ...
            <div>
                ...
                <nav class="p-4 space-y-1.5">
                    ...
                    @if(auth()->user()->hasPermission('usuarios_roles', 'ver') || auth()->user()->isAdmin())
                    <a href="{{ route('recursos-humanos.index') }}" @click="sidebarOpen = false"
                       class="flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-all duration-200 {{ request()->routeIs('recursos-humanos.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-100' }}">
                    ...
                    <div class="pt-6 mt-6 border-t border-slate-800">
                        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-3 block px-3">Ajustes del Sistema</span>
                        <a href="{{ route('usuarios.index') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition hover:bg-slate-800/50 hover:text-white {{ request()->routeIs('usuarios.*') || request()->routeIs('roles.*') ? 'bg-slate-800/50 text-white' : 'text-slate-400' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                            <span class="text-xs font-semibold">Usuarios y Roles</span>
                        </a>
                        
                        <a href="{{ route('configuracion.index') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition hover:bg-slate-800/50 hover:text-white {{ request()->routeIs('configuracion.*') ? 'bg-slate-800/50 text-white' : 'text-slate-400' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span class="text-xs font-semibold">Configuración General</span>
                        </a>

                        <a href="{{ route('auditoria.index') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-xl transition hover:bg-slate-800/50 hover:text-white {{ request()->routeIs('auditoria.*') ? 'bg-slate-800/50 text-white' : 'text-slate-400' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                            <span class="text-xs font-semibold">Registro de Auditoría</span>
                        </a>
                    </div>
                    @endif
