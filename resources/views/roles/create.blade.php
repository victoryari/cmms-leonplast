...
@section('title', 'Crear Nuevo Rol de Usuario')
...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-extrabold text-white tracking-tight">Crear Nuevo Rol de Usuario</h2>
            <p class="text-xs text-slate-400 mt-1">Configura la matriz de permisos por módulo para restringir o conceder accesos en el CMMS</p>
        </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" required placeholder="Ej: Inspector_Calidad / Planificador_Mantenimiento"
                    ...
                    <div>
                        ...
                        <input type="text" id="descripcion" name="descripcion" value="{{ old('descripcion') }}" placeholder="Ej: Acceso a reportes y aprobación de repuestos"
                               class="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-500">
                    </div>
                </div>
            </div>
            ...
            <div class="pt-4 border-t border-slate-800">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-[11px] text-slate-400">Marca los permisos requeridos para este rol</p>
                    </div>
                    ...
                    <div class="p-4 rounded-2xl bg-slate-950 border border-slate-800/80 space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                            ...
                            <label class="flex items-center space-x-2.5 p-2 rounded-xl bg-slate-900/60 border border-slate-800/60 hover:border-slate-700 cursor-pointer transition">
                                <input type="checkbox" name="permisos[{{ $modKey }}][{{ $accKey }}]" value="1" 
